...
#'
#' @export
run_app_show_data <- function(optional_stats = "all"){
  
  G <- .GlobalEnv
  assign("optional_stats", optional_stats, envir = G)
  shiny::runApp(system.file("test_modules/app_test_show_data.R", 
...
#'
#' @export
run_app_filter_and_show_data <- function(optional_stats){
